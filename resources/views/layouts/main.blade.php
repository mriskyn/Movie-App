        ...
        <div class="container mx-auto px-4 flex flex-col md:flex-row flex items-center justify-between px-4 py-6">
           ...
           <div class="flex flex-col md:flex-row items-center">
                ...
                <div class="md:ml-4 mt-3 md:mt-0">
                    <a href="#">
                        <img src="https://raw.githubusercontent.com/drehimself/laravel-movies-example/master/public/img/avatar.jpg" alt="avatar" class="rounded-full w-8 h-8">
                    </a>
                </div>
            </div>
        </div>
